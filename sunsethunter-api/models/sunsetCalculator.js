...
module.exports = {
  ...
  calculateDewPoint: function (temperature, humidity) {
    //calculate dew point
    let dewPoint =
  ...
  calculateSunsetSunriseQuality: function (
    cloudCover,
    temperature,
    airQuality,
    humidity,
    ...
    let quality = 0;
    let cloudCoverValue = cloudCover;
    //let dewPointValue = calculateDewPoint(temperature, humidity);
    let airQualityValue = airQuality;
    let humidityValue = humidity;
    let windSpeedValue = windSpeed; //kph
    let precipitationValue = precipitation; //mm
    let visibility = vis;
